...
class ConnectionManager:
    ...
    def disconnect(self, websocket: WebSocket):
        ...
        logger.info(f"WebSocket connection disconnected. Active connections: {len(self.active_connections)}")
    ...
    async def broadcast_to_user(self, user_id: UUID, message: dict):
        ...
        logger.debug(f"Broadcasting message to user {user_id} ({len(user_connections)} connections)")
