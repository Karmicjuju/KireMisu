...
class JobScheduleRequest(BaseModel):
    ...
    job_type: str = Field(..., description="Type of job to schedule (library_scan, auto_schedule, download)")
    library_path_id: Optional[UUID] = Field(
    ...
    series_id: Optional[UUID] = Field(None, description="Optional local series ID to associate with")
