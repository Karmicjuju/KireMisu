...
def with_db_retry(
    max_attempts: int = db_config.DEFAULT_MAX_ATTEMPTS, delay: float = db_config.DEFAULT_RETRY_DELAY
):
...
def log_slow_query(
    query_name: str, duration_threshold: float = db_config.DEFAULT_SLOW_QUERY_THRESHOLD
):
