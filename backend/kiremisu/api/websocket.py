...
@router.get("/stats", response_model=dict, responses={
...
async def get_websocket_stats() -> dict:
    ...
    try:
        ...
        return {
            ...
            "message": "WebSocket system disabled until authentication implemented" if not connection_manager.enabled else "WebSocket system operational"
        }
    except Exception as e:
...
@router.post("/enable", response_model=dict, responses={
    ...
    **Warning**: Only enable after implementing proper user authentication
    ...
    try:
        ...
        return {
            ...
            "warning": "Ensure proper authentication is implemented before enabling in production" if enabled else None
        }
    except Exception as e:
...
@router.post("/test-broadcast", response_model=dict, responses={
