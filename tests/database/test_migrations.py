...
def test_migration_file_exists() -> None:
    ...
    assert "create_table('series'" in content, "Series table creation should be in migration"
    assert "create_table('chapters'" in content, "Chapters table creation should be in migration"
    assert "create_table('annotations'" in content, "Annotations table creation should be in migration"
