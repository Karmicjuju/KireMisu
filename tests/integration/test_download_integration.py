...
from kiremisu.services.job_worker import JobExecutionError, JobWorker
...
class TestDownloadJobQueueIntegration:
    ...
    async def test_job_queue_priority_handling(self, mock_db):
        ...
        await download_service.enqueue_single_chapter_download(
            db=mock_db,
    ...
    async def test_job_status_transitions(self, mock_db):
        ...
        update_calls = list(mock_db.execute.call_args_list)
