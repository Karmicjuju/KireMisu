...
from kiremisu.api.filesystem import validate_path_input, validate_path_security, MANGA_STORAGE_BASE
...
class TestSecurityLogging:
    ...
    def test_traversal_attempts_logged(self, client, temp_manga_storage, caplog):
        ...
        response = client.get(f"/api/filesystem/browse?path={traversal_path}")
